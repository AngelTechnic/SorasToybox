...
namespace SorasToybox.Items
{
    public class BadPublicity
    {
        public static void Add()
        {
            ...
            ModdedAchievements unlockAchievement = new ModdedAchievements(badPublicity.item._itemName, "Unlocked a new item.", ResourceLoader.LoadSprite("Ach_Deathmatch_Kleiver", null, 32, null), achievementID);
            unlockAchievement.AddNewAchievementToCUSTOMCategory("AntagonistTitleLabel", "The Antagonist");

            LoadedAssetsHandler.GetCharacter("Kleiver_CH").m_BossAchData.Add(new("Deathmatch_BOSS", achievementID));
