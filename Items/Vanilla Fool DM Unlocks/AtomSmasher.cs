...
namespace SorasToybox.Items
{
    public class AtomSmasher
    {
        public static void Add()
        {
            ...
            ModdedAchievements unlockAchievement = new ModdedAchievements(atomSmasher.item._itemName, "Unlocked a new item.", ResourceLoader.LoadSprite("Ach_Deathmatch_Griffin", null, 32, null), achievementID);
