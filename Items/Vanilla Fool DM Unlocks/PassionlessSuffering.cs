...
namespace SorasToybox.Items
{
    public class PassionlessSuffering
    {
        public static void Add()
        {
            ...
            ModdedAchievements unlockAchievement = new ModdedAchievements(passionless.item._itemName, "Unlocked a new item.", ResourceLoader.LoadSprite("Ach_Deathmatch_Griffin", null, 32, null), achievementID);
