...
namespace SorasToybox.Items
{
    public class FishOutOfWater
    {
        public static void Add()
        {
            ...
            ModdedAchievements unlockAchievement = new ModdedAchievements(fishOutOfWater.item._itemName, "Unlocked a new item.", ResourceLoader.LoadSprite("Ach_Deathmatch_Mung", null, 32, null), achievementID);
