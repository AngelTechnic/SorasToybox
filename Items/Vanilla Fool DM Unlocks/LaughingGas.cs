...
namespace SorasToybox.Items
{
    public class LaughingGas
    {
        public static void Add()
        {
            ...
            ModdedAchievements unlockAchievement = new ModdedAchievements(laughingGas.item._itemName, "Unlocked a new item.", ResourceLoader.LoadSprite("Ach_Deathmatch_Thype", null, 32, null), achievementID);
