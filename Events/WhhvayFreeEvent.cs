...
namespace SorasToybox.Events
{
    public class WhhvayFreeEvent
    {
        public static void Add()
        {
            ...
            Dialogues.CreateAndAddCustom_DialogueSO(text, yarnProgram, text, "SorasToybox.Whhvay.TryHire");
            Portals.AddPortalSign(text3, ResourceLoader.LoadSprite("whhvay_overworld", new Vector2(0.5f, 0f), 32), Portals.NPCIDColor);
